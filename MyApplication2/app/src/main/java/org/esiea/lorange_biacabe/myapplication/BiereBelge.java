...
public class BiereBelge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biere_belge);

        GetBiersServices.startActionGet_All_Biers(this);

        rv_bieres = (RecyclerView) findViewById(R.id.rv_bierebe);
    ...
    private class BiersAdapter extends RecyclerView.Adapter<BiersAdapter.BierHolder> {
        ...
        public BierHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            View v = li.inflate(R.layout.content_biere_belge, viewGroup, false);
        ...
        class BierHolder extends RecyclerView.ViewHolder {
            ...
            public BierHolder(View itemView) {
                super(itemView);
                name = (Button) itemView.findViewById(R.id.rv_bier_element_name_be);
